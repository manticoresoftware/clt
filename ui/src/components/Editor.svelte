...
<style>
  ...
  .add-first-command-button:hover svg, .add-first-block-button:hover svg, .add-first-comment-button:hover svg {
    color: #ffffff;
  }

  .add-first-command-button svg, .add-first-block-button svg, .add-first-comment-button svg {
    color: white;
    opacity: 1;
  }
